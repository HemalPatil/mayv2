...
CC64 := x86_64-elf-g++
CC64_FLAGS := --std=c++20 -ffreestanding -fno-exceptions -fno-rtti -mcmodel=kernel -m64 -march=x86-64 -mno-red-zone -msse4.2 -nostdlib -lgcc -I$(STD_INCLUDE_DIR) -I$(KERNEL_INCLUDE_DIR)
