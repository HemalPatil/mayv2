...
bool initializeVirtualMemory(uint64_t higherHalfUsableStart) {
	// TODO : add initialize vir mem implementation
	terminalPrintString(initVirMemStr, strlen(initVirMemStr));

	// TODO: create new PML4 table
	// Move important structures like physical memory bitmap to higher half
