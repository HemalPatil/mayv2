...
namespace AHCI {
	...
	extern void deviceMsiHandler(Device *device);
	// extern bool ahciIdentifySatapiDevice(Controller *controller, Device *device);
	// extern bool ahciRead(Controller *controller, Device *device, size_t startSector, size_t count, void *buffer);
	// extern bool configureAhciDevice(Controller *controller, Device *device);
	// extern size_t findAhciFreeCommandSlot(Device *device);
	extern bool initialize(PCIeFunction *pcieFunction);
	// extern void startAhciCommand(Device *device);
	// extern void stopAhciCommand(Device *device);
